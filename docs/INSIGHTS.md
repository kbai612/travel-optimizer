...
_Auto-generated from `warehouse.duckdb` on 2026-07-19 10:20 UTC, covering 23 destinations × 12 months. Numbers reflect whatever real data the warehouse currently holds (coverage varies by source — see the coverage table below)._
...
- **Directional agreement:** for **8/8** destinations the recommended months average a higher travel score than the rest of the year (mean margin **+5.3** points).
...
| New York (JFK) | late spring & crisp autumn | 70.8 | 60.3 | +10.5 | Aug ≈ |
| Reykjavik (KEF) | the short Icelandic summer | 67.1 | 55.0 | +12.1 | Jul ✅ |
...
| Barcelona (BCN) | Aug | 69.3 | 80% | warm seas |
...
| Dubai (DXB) | Dec | 49.0 | 68% | mild weather |
...
| New York (JFK) | Aug | 83.5 | 80% | few holiday spikes |
