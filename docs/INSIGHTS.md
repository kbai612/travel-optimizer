...
_Auto-generated from `warehouse.duckdb` on 2026-07-03 05:56 UTC, covering 8 destinations × 12 months. Numbers reflect whatever real data the warehouse currently holds (coverage varies by source — see the coverage table below)._
...
- **Northern**: 4/5 peak in the Apr–Sep half.
