...
_Auto-generated from `warehouse.duckdb` on 2026-08-24 08:17 UTC, covering 23 destinations × 12 months. Numbers reflect whatever real data the warehouse currently holds (coverage varies by source — see the coverage table below)._
...
| Rio de Janeiro (GIG) | the dry Southern-Hemisphere winter | 75.9 | 73.4 | +2.5 | Aug ✅ |
| Tokyo (HND) | cherry-blossom spring & autumn foliage | 71.2 | 71.8 | -0.6 | Jun ≈ |
| New York (JFK) | late spring & crisp autumn | 72.0 | 61.1 | +10.8 | Sep ✅ |
| Reykjavik (KEF) | the short Icelandic summer | 71.2 | 56.7 | +14.4 | Jul ✅ |
| Lisbon (LIS) | spring & early-autumn shoulder season | 73.1 | 76.1 | -2.9 | Jan ✗ |
...
| Cape Town (CPT) | Jan | 84.8 | 100% | mild weather |
