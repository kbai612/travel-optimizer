...
_Auto-generated from `warehouse.duckdb` on 2026-08-31 14:42 UTC, covering 23 destinations × 12 months. Numbers reflect whatever real data the warehouse currently holds (coverage varies by source — see the coverage table below)._
...
- **Directional agreement:** for **6/8** destinations the recommended months average a higher travel score than the rest of the year (mean margin **+4.8** points).
...
|---|---|---:|---:|---:|---|
| Bangkok (BKK) | cool, dry season | 76.1 | 71.5 | +4.7 | Jan ✅ |
| Cape Town (CPT) | Southern-Hemisphere summer & autumn | 74.1 | 70.4 | +3.7 | Jan ✅ |
| Rio de Janeiro (GIG) | the dry Southern-Hemisphere winter | 77.3 | 73.3 | +4.0 | Aug ✅ |
| Tokyo (HND) | cherry-blossom spring & autumn foliage | 71.2 | 71.8 | -0.5 | Jun ≈ |
| New York (JFK) | late spring & crisp autumn | 71.8 | 61.4 | +10.4 | Sep ✅ |
| Reykjavik (KEF) | the short Icelandic summer | 71.1 | 56.7 | +14.3 | Jul ✅ |
| Lisbon (LIS) | spring & early-autumn shoulder season | 73.4 | 75.9 | -2.5 | Jan ✗ |
| Sydney (SYD) | late summer, autumn & spring | 75.4 | 71.3 | +4.1 | Feb ✅ |
...
| Los Angeles (LAX) | Aug | 82.0 | 80% | few holiday spikes |
| London (LHR) | Sep | 80.1 | 70% | good fares |
| Lisbon (LIS) | Jan | 82.0 | 100% | good fares |
| Marrakesh (RAK) | Oct | 83.1 | 70% | few holiday spikes |
